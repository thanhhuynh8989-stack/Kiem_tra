...
Compresses a Base64 image string or Blob to a optimized JPEG Base64 string.
*/
static async compressBase64Image(
base64Data,
maxWidth = APP_CONFIG.MAX_IMAGE_WIDTH,
maxHeight = APP_CONFIG.MAX_IMAGE_HEIGHT,
quality = APP_CONFIG.IMAGE_JPEG_QUALITY
) {
